...
double *SetupForMultiFit::ptrGetCoefficient(int coeffID) { 
    this->returnFromGslCoefficient = gsl_vector_get(this->coefficients, coeffID );
    return ptrReturnFromGslCoefficient;
}
